...
```{r}
# Final Option #1
final_vals1 <- c("#012169","#A1B70D", "#00539B", "#339898", "#C84E00", "#993399", "#262626", "#E89923")
final_names1 <- c("Duke Navy Blue", "Piedmont", "Duke Royal Blue", "Eno", "Copper", "Ironweed", "Cast Iron", "Persimmon")
# Final Option #2
final_vals2 <- c("#00539B", "#E89923", "#012169","#339898", "#993399", "#A1B70D", "#262626", "#C84E00") 
final_names2 <- c("Duke Royal Blue", "Persimmon", "Duke Navy Blue", "Eno", "Ironweed", "Piedmont", "Cast Iron", "Copper")

final_melt <- mat_melt %>%
  dplyr::filter(Var1 %in% final_names1 & Var2 %in% final_names1)
...
mat_melt %>%
  dplyr::filter(Var1 %in% final_names2 & Var2 %in% final_names2) %>%
  dplyr::arrange(desc(value))
