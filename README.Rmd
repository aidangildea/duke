...
plot <- ggplot2::ggplot(iris, ggplot2::aes(Sepal.Length, Sepal.Width)) +
  ...
  ggplot2::labs(title = "Sepal Length vs. Sepal Width", caption = "Data sourced from iris in datasets package. ", x = "Sepal Length", y = "Sepal Width")

plot
```

Then, simply convert your visualization to Duke official colors by calling `theme_duke()` and `scale_duke_discrete`.
